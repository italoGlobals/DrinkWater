pipeline {
    ...
    environment {
        ...
        CI = "true"
        PATH = "$PATH:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:/var/lib/gems/3.0.0/bin:$HOME/.nvm/versions/node/v22.14.0/bin:$HOME/Android/Sdk/cmdline-tools/latest/bin:$HOME/Android/Sdk/platform-tools:$HOME/Android/Sdk/ndk/26.1.10909125:$HOME/.yarn/global/node_modules/.bin"
        NVM_DIR = "$HOME/.nvm"
